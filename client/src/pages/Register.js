        ...
        <div className="bg-white dark:bg-[#1e293b] rounded-[2.5rem] shadow-2xl dark:shadow-black/60 border border-gray-100 dark:border-gray-700/50 p-7 pt-12">
          <div className="text-center mb-6">
            <h2 className="text-3xl font-extrabold text-[#1e293b] dark:text-white mb-1">
              Join <span className="text-[#3498db]">Marg</span><span className="text-[#e67e22]">Disha</span>
            </h2>
            <p className="text-sm text-gray-500 dark:text-gray-400 font-medium">
              Have an account?{" "}
              <Link to="/login" className="text-[#e67e22] hover:underline font-bold">Sign in</Link>
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-3">
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1 ml-1">Full Name</label>
                <input
                  name="name"
                  type="text"
                  required
              ...
              <div className="md:col-span-2">
                <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1 ml-1">Email</label>
                <input
                  name="email"
                  type="email"
                  required
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1 ml-1">Password</label>
                <input
                  name="password"
                  type="password"
                  required
              ...
              <div>
                <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 mb-1 ml-1">Confirm</label>
                <input
